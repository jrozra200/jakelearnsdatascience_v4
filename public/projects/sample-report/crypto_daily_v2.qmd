...
plot_dat <- py$pred_dat %>% 
    ...
    mutate(metric = case_when(metric == "up_down_actual" ~ "RLE Analytics Returns",
                              ...
                              metric == "btc_up_down" ~ "BTC Returns",
                              metric == "eth_up_down" ~ "ETH Returns"))

ggplot(plot_dat, aes(x = pred_date, y = value, color = metric)) + 
    geom_line()  + 
    ggtitle(paste("RLE Analytics Returns vs. SPY, BTC, ETH since ", 
...
plot_dat <- eth_invest %>% 
    ...
    rename("quarter" = "quarter.y", 
           ...
           "BTC Returns" = "btc_up_down",
           "ETH Returns" = "eth_up_down") %>% 
