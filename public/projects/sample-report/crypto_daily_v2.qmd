...
get_spy_dat <- function(symbol = "SPY", 
                        freq_num = 1, 
                        freq = "d", 
                        period1 = as.numeric(format(as_datetime(Sys.Date() - days(97)), "%s")),
...
py$pred_dat %>% 
    ...
    ggplot(aes(x = pred_date, y = value, color = metric)) + 
        geom_line()  + 
        ggtitle(paste("Model Returns vs. SPY since ", format(first_date, "%B %d, %Y"))) +
